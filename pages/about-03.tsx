      ...
      <Main>
        ...
        <StatsThreeColumnWithDescription
          ...
          description={
            <>
              <p>
                Oatmeal was founded on the belief that customer support should
                be personal, fast, and most importantly, highly profitable.
              </p>
              <p>
                The problem with traditional AI customer support tools is that
                they often lack the human touch that customers crave. At
                Oatmeal, we combine the power of AI with a massive network of
                low wage workers stationed around the globe to deliver customer
                support that feels personal and authentic.
              </p>
              <p>
                Oatmeal's competitive advantage lies in the fact that we can
                undercut our competitors who rely on expensive hardware based
                compute. Our network of human based compute centers allows us to
                provide high-quality customer support at a fraction of the cost.
                Compared to data centers that consume massive amounts of
                electricity and water, our approach is both sustainable and cost
                effective.
              </p>
            </>
          }
        >
          ...
          <Stat
            stat="70+"
            text="Countries where we have low wage workers pretending to be AI."
          />
        </StatsThreeColumnWithDescription>
