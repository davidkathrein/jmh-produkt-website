    ...
    <>
      ...
      <Main>
        ...
        <HeroLeftAlignedWithDemo
          ...
          subheadline={
            <p>
              ...
              every customer a reply that feels personal — even if it was
              generated by a bot.
            </p>
          }
          cta={
        ...
        <FeaturesTwoColumnWithDemos
          ...
          subheadline={
            <p>
              ...
              right where it belongs — in one simple inbox.
            </p>
          }
          features={
            <>
              <Feature
                demo={
                  <Screenshot wallpaper="purple" placement="bottom-right">
                    ...
                    />
                    <Image
                      src="https://assets.tailwindplus.com/screenshots/1.webp?left=1000&top=800&color=mist"
                      alt=""
                    ...
                    />
                    <Image
                      src="https://assets.tailwindplus.com/screenshots/1.webp?left=1800&top=660&color=mist"
                      alt=""
                    ...
                    />
                    <Image
                      src="https://assets.tailwindplus.com/screenshots/1.webp?left=1300&top=1300&color=mist"
                      alt=""
                ...
                subheadline={
                  <p>
                    Keep every customer conversation in one clean, collaborative
                    inbox. A single source of truth is much easier to ignore.
                  </p>
                }
                cta={
                  <Link href="#">
              ...
              <Feature
                demo={
                  <Screenshot wallpaper="blue" placement="bottom-left">
                    ...
                    />
                    <Image
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1000&top=800&color=mist"
                      alt=""
                      className="bg-black/75 not-dark:hidden sm:hidden"
                      width={1000}
                      height={800}
                    ...
                    />
                    <Image
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1800&top=660&color=mist"
                      alt=""
                      className="bg-black/75 not-dark:hidden max-sm:hidden lg:hidden"
                      width={1800}
                      height={660}
                    ...
                    />
                    <Image
                      src="https://assets.tailwindplus.com/screenshots/1.webp?right=1300&top=1300&color=mist"
                      alt=""
                      className="bg-black/75 not-dark:hidden max-lg:hidden xl:hidden"
                      width={1300}
                      height={1300}
        ...
        <CallToActionSimple
          ...
          subheadline={
            <p>
              Join hundreds of teams using Oatmeal to deliver faster, friendlier
