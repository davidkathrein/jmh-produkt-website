    ...
    <>
      ...
      <Main>
          ...
          plans={
            <>
              <Plan
                ...
                price="Free"
                subheadline={
                  <p>Individuals getting started with shared inboxes</p>
                }
                features={[
                  "One inbox",
                  "Private notes",
        ...
        <TestimonialThreeColumnGrid
          ...
          subheadline={
            <p>
              We've given these customers a significant discount in exchange for
        ...
        >
          <Testimonial
            quote={
              <p>
                ...
                operations. To be fair, we weren't doing any customer support at
                all so the bar was pretty low.
              </p>
            }
            img={
              <Image
          ...
          <Testimonial
            quote={
              <p>
                We use Oatmeal's automation features to make cancellation
          ...
          <Testimonial
            quote={
              <p>
                I've been using the spare time that Oatmeal has freed up to work
                not just one, but two other jobs, all while hitting my core
                KPIs. My bosses have no idea.
              </p>
            }
            img={
              <Image
          ...
          <Testimonial
            quote={
              <p>
                Oatmeal has given us key insights into how much our customers
          ...
          <Testimonial
            quote={
              <p>
                As a solo founder, Oatmeal has been a lifesaver. It makes it
          ...
          <Testimonial
            quote={
              <p>
                Thanks to Oatmeal, we've managed to cut our support costs in
